...
import com.example.myapplication.test.CalendarHelper;
import com.example.myapplication.test.CustomOnItemSelectedListener;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void addNewEvent()
    {
        ...
        CalendarHelper.MakeNewCalendarEntry(this, "Test", "Add event", "Somewhere",tenMinutesFromNow,tenMinutesFromNow+oneHour,false,true,calendar_id,2);
